    ...
    if (project.members[i].id === req.user.id) {
      if (
        ...
        const mailOptions = {
          ...
          text: `Hi ${req.body.name}, you have been invited to join project ${project.title} by ${user.name}. Please click on the link to join the project. ${process.env.API_URL || "http://localhost:8700/api"}/project/invite/${req.params.id}/${req.body.id}`,
        };
